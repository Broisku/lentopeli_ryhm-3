...
def fetchrunway(connect, player, icao):
    ...
    if airport_type == "small_airport":
        if len(result_runway_count) < 1:
            ...
            return "Runways available for small airport: 2 x 1500m runway"
        elif len(result_runway_count) < 2:
            print("Runways still available: 1 x 1500m runway")
            return "Runways available for small airport: 1 x 1500m runway"
        else:
            print("No runways available")
            return "No runways available"

    if airport_type == "medium_airport":
        if len(result_runway_count) < 1:
            print("Runways available for medium airport: 3 x 3000m runways")
            return "Runways available for medium airport: 3 x 3000m runways"
        elif len(result_runway_count) < 2:
            print("Runways available: 2 x 3000m runway")
            return "Runways available for medium airport: 2 x 3000m runways"
        elif len(result_runway_count) < 3:
            print("Runways available: 1 x 3000m runway")
            return "Runways available for medium airport: 1 x 3000m runway"
        else:
            print("No runways available")
            return "No runways available"
    ...
    if airport_type == "large_airport":
        if len(result_runway_count) < 1:
            ...
            return "Runways available for large airport: 4 x 4500m runways"
        elif len(result_runway_count) < 2:
            print("Runways available: 3 x 4500m runway")
            return "Runways available for large airport: 3 x 4500m runways"
        elif len(result_runway_count) < 3:
            print("Runways available: 2 x 4500m runway")
            return "Runways available for large airport: 2 x 4500m runways"
        elif len(result_runway_count) < 4:
            print("Runways available: 1 x 4500m runway")
            return "Runways available for large airport: 1 x 4500m runway"
        else:
            print("No runways available")
            return "No runways available"
